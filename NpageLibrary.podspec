...
Pod::Spec.new do |s|
  s.name             = 'NpageLibrary'
  s.version          = '0.1.0'
  s.summary          = 'A short description of NpageLibrary.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ho/NpageLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ho' => 'ho@npage.co.kr' }
  s.source           = { :git => 'https://github.com/ho/NpageLibrary.git', :tag => s.version.to_s }
